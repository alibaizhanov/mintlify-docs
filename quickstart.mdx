...
## 6. Auto-save from Claude Code

If you use Claude Code, set up automatic memory capture with one command:
...
Every 3rd Claude Code response is automatically saved to your memory. See [Claude Code Auto-Save](/claude-code) for details.
