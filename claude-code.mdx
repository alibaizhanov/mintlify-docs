...
description: "Memory that survives /clear and auto-compaction — auto-save conversations, auto-recall context on every prompt, and load your profile on session start."
---
