---
title: "Quickstart"
description: "Look at what memory would already know — no account. Then keep it, in under 2 minutes."
---

## 0. See what it would know — no account needed

Before anything else, look at what memory would already hold. This reads the
Claude Code history on your own disk, uploads nothing, and needs no key:
...
Three seconds, and nothing to undo if you walk away. If the command is not
found afterwards, your user-site bin is not on PATH:
`export PATH="$(python3 -m site --user-base)/bin:$PATH"`.

Like what you see? Keep it — the steps below take about two minutes.
